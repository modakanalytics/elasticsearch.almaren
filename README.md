...
```
spark-shell --master local[*] --packages "com.github.music-of-the-ainur:almaren-framework_2.12:0.9.10-3.2,com.github.music-of-the-ainur:elasticsearch-almaren_2.12:0.0.3-3.2,org.elasticsearch:elasticsearch-spark-30_2.12:8.10.2"
```

Elasticsearch-Almaren is available in [Maven Central](https://mvnrepository.com/artifact/com.github.music-of-the-ainur)
repository.
