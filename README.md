...
```
spark-shell --master local[*] --packages "com.github.music-of-the-ainur:almaren-framework_2.12:0.9.10-3.3,com.github.music-of-the-ainur:elasticsearch-almaren_2.12:0.0.3-3.3,org.elasticsearch:elasticsearch-spark-30_2.12:8.10.2"
```
For scala-version(2.13):
```
spark-shell --master local[*] --packages "com.github.music-of-the-ainur:almaren-framework_2.13:0.9.10-3.3,com.github.music-of-the-ainur:elasticsearch-almaren_2.13:0.0.3-3.3,org.elasticsearch:elasticsearch-spark-30_2.13:8.10.2"
```
