...
```
libraryDependencies += "com.github.music-of-the-ainur" %% "elasticsearch-almaren" % "0.0.3-2.4"
libraryDependencies += "org.elasticsearch" %% "elasticsearch-spark-20" % "8.10.2"
```

To run in spark-shell:
```
spark-shell --master local[*] --packages "com.github.music-of-the-ainur:almaren-framework_2.12:0.9.10-2.4,com.github.music-of-the-ainur:elasticsearch-almaren_2.12:0.0.3-2.4,org.elasticsearch:elasticsearch-spark-20_2.12:8.10.2"
```
