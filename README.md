...
libraryDependencies += "org.elasticsearch" %% "elasticsearch-spark-20" % "8.4.3"
```

To run in spark-shell:
```
spark-shell --master local[*] --packages "com.github.music-of-the-ainur:almaren-framework_2.12:0.9.8-2.4,com.github.music-of-the-ainur:elasticsearch-almaren_2.12:0.0.3-2.4,org.elasticsearch:elasticsearch-spark-20_2.12:8.4.3"
```
